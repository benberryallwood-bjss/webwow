...
import { body, favouriteYear, form, addButton, toTopButton, noAlbumsHeading, favouriteYearHeading, albumsSection } from './selectors.js';
...
form.onsubmit = (e) => __awaiter(void 0, void 0, void 0, function* () {
    yield formSubmitHandler(e, editingId);
    updateTable();
    updateFavouriteYear();
    editingId = null;
});
...
const updateTable = () => __awaiter(void 0, void 0, void 0, function* () {
    clearTableBody();
    albums = yield api.getAlbums();
    albums.forEach((album) => {
        addAlbumToTable(album);
    });
});
const updateFavouriteYear = () => __awaiter(void 0, void 0, void 0, function* () {
    let year = yield api.getFavouriteYear();
    if (year) {
